namespace expense_manager
{
	partial class AddProfileForm
	{
		...
		private void InitializeComponent()
		{
			...
			// profileNameInput
			// 
			this.profileNameInput.Location = new System.Drawing.Point(89, 62);
			this.profileNameInput.Name = "profileNameInput";
			this.profileNameInput.Size = new System.Drawing.Size(100, 20);
			this.profileNameInput.TabIndex = 0;
			// 
			// button1
			// 
